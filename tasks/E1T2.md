...
Add a /count command that reads the current value of the global counter from the SQLite database and replies with 'Total pings served: <N>'. Write the dialog spec to tests/specs/E1T2.json and append the command to tests/commands.json.
