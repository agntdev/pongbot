# E2T1 — Implement /start command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 PONG

Add a /start command that replies with a warm greeting, such as 'Hi — I'm PongBot! Send /ping to get a pong 🏓 and increment the global counter.' Write the dialog spec to tests/specs/E2T1.json and append the command to tests/commands.json.
