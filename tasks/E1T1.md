# E1T1 — Implement /ping command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 PONG

Add a /ping command that replies with 'pong 🏓' and atomically increments the global counter in the SQLite database. Write the dialog spec to tests/specs/E1T1.json and append the command to tests/commands.json.
