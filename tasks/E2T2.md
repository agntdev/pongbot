# E2T2 — Handle unknown commands

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 PONG

Implement a fallback for unknown commands that replies with a single-line hint: 'Use /ping or /count.' Write the dialog spec to tests/specs/E2T2.json and append the command to tests/commands.json.
